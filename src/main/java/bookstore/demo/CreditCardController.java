...
public class CreditCardController {
    ...
    private CreditService cred_serv;

    @Autowired
    public CreditCardController(CreditService cred_serv) {this.cred_serv=cred_serv;}
    ...
    public void createCard(@RequestBody CreditCard c) {cred_serv.createCard(c);}
}
